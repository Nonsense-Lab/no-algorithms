...
#define InitZeroOneSolve(type1) \
	typedef type1 (*Function_Loading##type1)(type1, type1); \
	type1 ZeroOneSolve_##type1(type1 _N, type1 _M, type1* _Result, type1* _Value, type1* _Weight, Function_Loading##type1 func) { \
		_Result[0] = 0; \
